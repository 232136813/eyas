namespace java com.lenovo.ecs.eyas.thrift
...
service Eyas {
   ...
   */
  i32 confirm(1: string queue_name, 2: set<i32> ids)

  /*
   * Abort a set of items previously fetched with `get`.
   * Returns the count of aborted items.
   */
  i32 abort(1: string queue_name, 2: set<i32> ids)
  ...
  /*
   * Return a string form of the version of this Eyas server.
   */
  string get_version()
}
