...
;
  ...
  public int compareTo(QueueInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetHead_item()).compareTo(other.isSetHead_item());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetJournal_bytes()).compareTo(other.isSetJournal_bytes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetWaiters()).compareTo(other.isSetWaiters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWaiters()) {
    ...
    lastComparison = Boolean.valueOf(isSetOpen_transactions()).compareTo(other.isSetOpen_transactions());
    if (lastComparison != 0) {
      return lastComparison;
    }
