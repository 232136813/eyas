 ...
 *  @generated
 */
package com.lenovo.ecs.eyas.thrift;
...
public class Eyas {
  ...
  public interface Iface {
    ...
    public int confirm(String queue_name, Set<Integer> ids) throws org.apache.thrift.TException;

    public int abort(String queue_name, Set<Integer> ids) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void confirm(String queue_name, Set<Integer> ids, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void abort(String queue_name, Set<Integer> ids, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_confirm(String queue_name, Set<Integer> ids) throws org.apache.thrift.TException
    {
    ...
    public void send_abort(String queue_name, Set<Integer> ids) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class confirm_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public confirm_call(String queue_name, Set<Integer> ids, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.queue_name = queue_name;
        this.ids = ids;
      }
    ...
    public static class abort_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String queue_name;
      private Set<Integer> ids;
      public abort_call(String queue_name, Set<Integer> ids, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.queue_name = queue_name;
        this.ids = ids;
      }
  ...
  public static class put_args implements org.apache.thrift.TBase<put_args, put_args._Fields>, java.io.Serializable, Cloneable, Comparable<put_args>   {
    ...
    public int compareTo(put_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetQueue_name()).compareTo(other.isSetQueue_name());
      if (lastComparison != 0) {
      ...
      lastComparison = Boolean.valueOf(isSetExpiration_msec()).compareTo(other.isSetExpiration_msec());
      if (lastComparison != 0) {
        return lastComparison;
      }
          ...
          switch (schemeField.id) {
            ...
            case 3: // EXPIRATION_MSEC
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                ...
                struct.setExpiration_msecIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
    ...
    private static class put_argsTupleScheme extends TupleScheme<put_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, put_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetExpiration_msec()) {
          optionals.set(2);
        }
  ...
  public static class get_args implements org.apache.thrift.TBase<get_args, get_args._Fields>, java.io.Serializable, Cloneable, Comparable<get_args>   {
    ...
    public int compareTo(get_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetMax_items()).compareTo(other.isSetMax_items());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetMax_items()) {
      ...
      lastComparison = Boolean.valueOf(isSetTimeout_msec()).compareTo(other.isSetTimeout_msec());
      if (lastComparison != 0) {
        return lastComparison;
      }
      ...
      lastComparison = Boolean.valueOf(isSetAuto_abort_msec()).compareTo(other.isSetAuto_abort_msec());
      if (lastComparison != 0) {
        return lastComparison;
      }
          ...
          switch (schemeField.id) {
            ...
            case 3: // TIMEOUT_MSEC
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                ...
                struct.setTimeout_msecIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
            case 4: // AUTO_ABORT_MSEC
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                ...
                struct.setAuto_abort_msecIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
    ...
    private static class get_argsTupleScheme extends TupleScheme<get_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, get_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetMax_items()) {
          optionals.set(1);
        }
        if (struct.isSetTimeout_msec()) {
          optionals.set(2);
        }
        if (struct.isSetAuto_abort_msec()) {
          optionals.set(3);
        }
  ...
  public static class confirm_args implements org.apache.thrift.TBase<confirm_args, confirm_args._Fields>, java.io.Serializable, Cloneable, Comparable<confirm_args>   {
    ...
    public String queue_name; // required
    public Set<Integer> ids; // required
    ...
    public confirm_args(confirm_args other) {
      ...
      if (other.isSetIds()) {
        Set<Integer> __this__ids = new HashSet<Integer>(other.ids);
    ...
    public confirm_args setIds(Set<Integer> ids) {
      this.ids = ids;
      return this;
    }
    ...
    private static class confirm_argsStandardScheme extends StandardScheme<confirm_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.ids = new HashSet<Integer>(2*_set16.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, confirm_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.ids != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, struct.ids.size()));
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.ids = new HashSet<Integer>(2*_set21.size);
  ...
  public static class abort_args implements org.apache.thrift.TBase<abort_args, abort_args._Fields>, java.io.Serializable, Cloneable, Comparable<abort_args>   {
    ...
    public abort_args setIds(Set<Integer> ids) {
      this.ids = ids;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.ids = new HashSet<Integer>(2*_set24.size);
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.ids = new HashSet<Integer>(2*_set29.size);
