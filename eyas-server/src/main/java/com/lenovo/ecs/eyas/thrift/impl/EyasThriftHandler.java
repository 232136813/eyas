...
public class EyasThriftHandler implements Eyas.Iface{
	...
	public QueueInfo peek(String queue_name) throws TException {
		throw new TException(new OperationNotSupportException());
	}
	...
	private boolean checkBlockReads(String op, String key) throws AvailabilityException{
	...
	private void checkBlockWrites(String op, String key) throws AvailabilityException{
